...
if(isset($_POST['update'])){
    ...
    $a = "SELECT * FROM CUSTOMER WHERE CUSTOMER_ID ='$customerid' AND CUSTOMER_REPASSWORD='$opass'";
    ...
    if($e == 1){
        if($npass == $rnpass){
            ...
            $v="UPDATE CUSTOMER SET PASSWORD ='$hashpass', CUSTOMER_REPASSWORD='$npass' WHERE CUSTOMER_ID='$customerid'";
        ...
        <div class="row justify-content-center ">
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                <form action="" class="form-container" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="float-left"><button type="submit" name="update" class="btn btn-success" style="background-color: #74b72e;">Update</button></div>
                    <div class="float-right"><button class="btn  log"><a href="customerview.php" style="text-decoration:none; color:white;">My Profile</a></button></div>
                    </div>
                </form>
            </div>
        </div>

...
#slider{
    margin-bottom: 40px;
			...
			.product-title, .price, .sizes, .colors,.stock ,.min,.max
			{
				text-transform: UPPERCASE;
				font-weight: bold; 
			}

			.checked, .price span,.stock span,.min span,.max span 
			{
				color: #74b72e; 
			}
...
echo'<div class="preview-pic tab-content">';
   ...
   echo'<div class="carousel-inner">';
     echo'<div class="item active">';
      echo'<center>';
       echo'<img class="img-responsive" src="products/'.$c['PRODUCT_PIC1'].'" alt="Product1">';
        echo'</center>';
     echo'</div>';
     echo'<div class="item">';
      echo'<center>';
       echo'<img class="img-responsive" src="products/'.$c['PRODUCT_PIC2'].'" alt="Product2">';
  
      echo'</center>';
         echo'</div>';
     echo'<div class="item">';
      echo'<center>';
       echo'<img class="img-responsive" src="products/'.$c['PRODUCT_PIC3'].'" alt="Product3">';
       echo'</center>';
     echo'</div>';
